...
def main():
	...
	st.title("SMEND Tweet Classifer App")
	...
	if selection == "Prediction":
		...
		if st.button("Classify"):
			...
			# Creating a description of the prediction
			prediction_description = classification.get(int(prediction))

			# When model has successfully run, will print prediction
			# You can use a dictionary or similar structure to make this output
			# more human interpretable.
			st.success("Text Categorized as: {}".format(prediction_description))
